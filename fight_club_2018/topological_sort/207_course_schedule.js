...
var canFinish = function(numCourses, prerequisites) {
  var courses =  graphify(prerequisites);
  let unvisited = new Set(Object.keys(courses));

  // let visitable = true;
  while (unvisited.size > 0) { // && visitable
    // visitable = false;
    ...
    if (beforeSize === unvisited.size) return false;
  }

  return unvisited.size === 0;
};

var graphify = function(edges) {
  let graph = {};
